...
static inline void PlClearColourF32( PLColourF32 *self ) {
	self->r = self->g = self->b = self->a = 0.0f;
}
...
static inline bool PlCompareColourF32( const PLColourF32 *a, const PLColourF32 *b )
{
