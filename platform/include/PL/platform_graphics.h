...
PL_EXTERN void plSetShaderUniformFloat(PLShaderProgram *program, int slot, float value);
...
PL_EXTERN void plSetShaderUniformVector3(PLShaderProgram *program, int slot, PLVector3 value);
