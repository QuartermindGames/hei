...
#ifdef M_PI
static constexpr float QM_MATH_PI = ( float ) M_PI;
#else
static constexpr float QM_MATH_PI = 3.14159265359f;
#endif
#define QM_MATH_180_DIV_PI ( 180.0f / QM_MATH_PI )
#define QM_MATH_PI_DIV_180 ( QM_MATH_PI / 180.f )

static constexpr float QM_MATH_TAU     = 6.28318530717f;
static constexpr float QM_MATH_EPSILON = 1e-6f;
